    ...
    function start_el( &$output, $object, $depth = 0, $args = array(), $id = 0) {
        ...
        if ( ( $cb_cat_menu == 1 ) && ( $object->menu_item_parent == '0' ) ) {
            ...
            while ( $cb_qry_latest->have_posts() ) {
                    ...
                    <div class="cb-meta">
                        <h2 class="h4"><a href="' . $cb_permalink . '">' . $cb_post_title . '</a></h2>
...
if ( ! function_exists( 'cb_author_details' ) ) {
    function cb_author_details($cb_author_id, $cb_desc = true) {
        ...
        $author = get_the_author();
         $image = '';
            if ($author == 'Maude Lebowski') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/maude.jpg" width="200"  alt="">' ;
            } else if ($author == 'Walter Sobchak') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/walter.jpg"  width="200" alt="">' ;
                # code...
            } else if ($author == 'dude') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/dude.jpg" width="200"  alt="">' ;
            }
            else 
                $image .=  get_avatar( $cb_author_id, '200' ) ;
        $cb_author_output .= '<div class="cb-author-details clearfix"><div class="cb-mask"><a href="'.get_author_posts_url($cb_author_id).'">'. $image.'</a></div><div class="cb-meta"><h3><a href="'.get_author_posts_url($cb_author_id).'">'.$cb_author_name.'</a></h3>';
...
if ( ! function_exists( 'cb_author_box' ) ) {
    function cb_author_box( $post, $cb_author_id_sc = NULL, $cb_block_title = NULL ) {
        ...
        if ( $cb_block_title == NULL ) {
            $cb_author_output .= '<div id="cb-author-box" class="clearfix"><h3 class="cb-block-title">' . __('Sobre el autor', 'cubell') . '</h3><div class="cb-mask"><a href="' . get_author_posts_url( $cb_author_id ) . '">';
            $author = get_the_author();
            if ($author == 'Maude Lebowski') {
                $cb_author_output .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/maude.jpg" width="120"  alt="">' ;
            } else if ($author == 'Walter Sobchak') {
                $cb_author_output .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/walter.jpg"  width="120" alt="">' ;
                # code...
            } else if ($author == 'dude') {
                $cb_author_output .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/dude.jpg" width="120"  alt="">' ;
            }
            else 
                $cb_author_output .=  get_avatar( $cb_author_id, '120' ) ;
...
if ( ! function_exists( 'cb_bbp_author_details' ) ) {
    function cb_bbp_author_details($cb_author_id, $cb_desc = true) {
        ...
        $image = '';
            if ($author == 'Maude Lebowski') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/maude.jpg" width="120"  alt="">' ;
            } else if ($author == 'Walter Sobchak') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/walter.jpg"  width="120" alt="">' ;
                # code...
            } else if ($author == 'dude') {
                $image .=  '<img src="http://www.porro.com.uy/wp-content/themes/valenti/library/images/dude.jpg" width="120"  alt="">' ;
            }
            else 
                $image .=  get_avatar( $cb_author_id, '120' ) ;
        
        $cb_author_output .= '<div class="cb-author-details cb-bbp clearfix"><div class="cb-mask"><a href="'. bbp_get_user_profile_url() .'" title="'. bbp_get_displayed_user_field( 'display_name' ) .'" rel="me">'. $image .'</a></div><div class="cb-meta"><h3><a href="'. bbp_get_user_profile_url() .'" title="'. bbp_get_displayed_user_field( 'display_name' ) .'">'.$cb_author_name.'</a></h3>';
